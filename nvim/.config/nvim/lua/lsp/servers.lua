...
local on_attach = function(client, bufnr)
    ...
    -- if client.resolved_capabilities.completion then lsp_completion.on_attach(client, bufnr) end
...
for _, lsp in ipairs(servers) do nvim_lsp[lsp].setup {on_attach = on_attach, flags = {debounce_text_changes = 150}, capabilities = capabilities} end
