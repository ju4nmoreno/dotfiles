...
vim.keymap.set('n', '<leader>qq', ':qall!<CR>', { desc = 'Close neovim' })
vim.keymap.set('n', '<leader>q', ':bw!<CR>', { desc = 'Close buffer' })
vim.keymap.set('n', '<leader>s', ':wall<CR>', { desc = 'Save all files' })
