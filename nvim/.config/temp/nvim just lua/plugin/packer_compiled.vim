...
_G.packer_plugins = {
  ["base16-vim"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/base16-vim"
  },
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
  ...
  indentLine = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/indentLine"
  },
  ["lspkind-nvim"] = {
    loaded = true,
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/nvim-tree.lua"
  },
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/nvim-treesitter"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/nvim-web-devicons"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["startuptime.vim"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/startuptime.vim"
  },
  ...
  ["vim-auto-save"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/vim-auto-save"
  },
  ["vim-closetag"] = {
    loaded = true,
    path = "/Users/jcmoreno/.local/share/nvim/site/pack/packer/start/vim-closetag"
  },
  ["vim-devicons"] = {
    loaded = true,
